...
class RottenTomatoesMovie(RottenTomatoesContainer, Base):
    ...
    release_dates = relationship('ReleaseDate', backref='movie', cascade='all, delete, delete-orphan')
    ...
    links = relationship('RottenTomatoesLink', backref='movie', cascade='all, delete, delete-orphan')
