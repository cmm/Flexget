...
class Season(Base):
    ...
    releases = relationship('SeasonRelease', backref='season', cascade='all, delete, delete-orphan')
...
class Episode(Base):
    ...
    identified_by = Column(String)
    series_id = Column(Integer, ForeignKey('series.id'), nullable=False)
    releases = relationship('EpisodeRelease', backref='episode', cascade='all, delete, delete-orphan')
